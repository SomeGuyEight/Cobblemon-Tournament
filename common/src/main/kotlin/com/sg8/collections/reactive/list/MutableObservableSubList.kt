...
class MutableObservableSubList<T>(
    ...
    private val subscriptionMap: MutableMap<Observable<*>, ObservableSubscription<*>> =
        mutableMapOf()
    ...
    private fun emitSwap(elementPair: Pair<T, T>, indices: Pair<Int, Int>) {
        val firstInWindow = indices.first.isInParentWindow()
        val secondInWindow = indices.second.isInParentWindow()
        when {
    ...
    private fun Int.isInParentWindow(): Boolean = this in fromIndex until toIndexInParent
