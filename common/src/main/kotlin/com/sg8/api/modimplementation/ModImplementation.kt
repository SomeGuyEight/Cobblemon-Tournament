...
abstract class ModImplementation(val commandImplementation: CommandImplementation) {
    ...
    open fun registerEvents() {
        ...
        CommandRegistrationEvent.EVENT.register(this.commandImplementation::registerCommands)
    }
