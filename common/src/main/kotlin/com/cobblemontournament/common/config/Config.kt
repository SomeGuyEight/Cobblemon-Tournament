...
data object Config
{
    ...
    private val DEFAULT_TOURNAMENT_STATUS       = TournamentStatus.UNKNOWN
    ...
    private var defaultTournamentStatus : TournamentStatus  = DEFAULT_TOURNAMENT_STATUS
    ...
    fun defaultTournamentStatus()   : TournamentStatus  = defaultTournamentStatus
    ...
    @JvmStatic
    fun initialize(
        defaultTournamentStatus : TournamentStatus?,
    ...
    {
        this.defaultTournamentStatus    = defaultTournamentStatus   ?: DEFAULT_TOURNAMENT_STATUS
