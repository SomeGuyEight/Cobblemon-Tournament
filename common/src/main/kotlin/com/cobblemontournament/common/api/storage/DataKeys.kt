...
object DataKeys
{
    ...
    const val TOURNAMENT_BUILDER_DATA       = "tournament_store_data"
    const val TOURNAMENT_DATA               = "tournament_data"
    ...
    const val ROUND_STORE_ID                = "round_store_id"
    const val MATCH_STORE_ID                = "match_store_id"
    const val PLAYER_STORE_ID               = "player_store_id"
    ...
    const val SEEDED_PLAYERS                = "seeded_players"
    const val UNSEEDED_PLAYERS              = "unseeded_players"
    ...
    const val PLAYER_ID_TO_TEAM_INDEX       = "player_id_to_team_index"
