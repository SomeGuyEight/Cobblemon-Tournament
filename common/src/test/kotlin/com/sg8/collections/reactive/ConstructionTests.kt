...
object ConstructionTests {
    ...
    fun setConstruction() {
        ...
        Assertions.assertTrue(observableSet.toObservableSet<String, Collection<String>>().containsAll(inputSet))
        Assertions.assertTrue(mutableObservableSet.toObservableSet<String, Collection<String>>().containsAll(inputSet))
        Assertions.assertTrue(emptyObservableSet.toObservableSet<String, Collection<String>>().isEmpty())
        Assertions.assertTrue(emptyMutableObservableSet.toObservableSet<String, Collection<String>>().isEmpty())
        ...
        Assertions.assertTrue(observableSet.toMutableObservableSet<String, Collection<String>>().containsAll(inputSet))
        Assertions.assertTrue(mutableObservableSet.toMutableObservableSet<String, Collection<String>>().containsAll(inputSet))
        Assertions.assertTrue(emptyObservableSet.toMutableObservableSet<String, Collection<String>>().isEmpty())
        Assertions.assertTrue(emptyMutableObservableSet.toMutableObservableSet<String, Collection<String>>().isEmpty())
    ...
    fun listConstruction() {
        ...
        Assertions.assertTrue(input.toObservableList<String, Collection<String>>().containsAll(input))
        Assertions.assertTrue(observable.toObservableList<String, Collection<String>>().containsAll(input))
        Assertions.assertTrue(mutableObservable.toObservableList<String, Collection<String>>().containsAll(input))
        Assertions.assertTrue(emptyObservable.toObservableList<String, Collection<String>>().isEmpty())
        Assertions.assertTrue(emptyMutableObservable.toObservableList<String, Collection<String>>().isEmpty())
        ...
        Assertions.assertTrue(input.toMutableObservableList<String, Collection<String>>().containsAll(input))
        Assertions.assertTrue(observable.toMutableObservableList<String, Collection<String>>().containsAll(input))
        Assertions.assertTrue(mutableObservable.toMutableObservableList<String, Collection<String>>().containsAll(input))
        Assertions.assertTrue(emptyObservable.toMutableObservableList<String, Collection<String>>().isEmpty())
        Assertions.assertTrue(emptyMutableObservable.toMutableObservableList<String, Collection<String>>().isEmpty())
    ...
    fun subListConstruction() {
        ...
        Assertions.assertTrue(mutableObservableSubList.toObservableList<String, Collection<String>>().containsAll(inputSubList))
        ...
        Assertions.assertTrue(mutableObservableSubSubList.toObservableList<String, Collection<String>>().containsAll(inputSubSubList))
        ...
        Assertions.assertTrue(mutableObservableSubList.toMutableObservableList<String, Collection<String>>().containsAll(inputSubList))
        ...
        Assertions.assertTrue(mutableObservableSubSubList.toMutableObservableList<String, Collection<String>>().containsAll(inputSubSubList))
    }
